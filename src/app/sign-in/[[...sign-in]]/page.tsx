        ...
        <div className="w-full lg:w-1/2 flex flex-col text-left space-y-8 lg:pr-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base sm:text-lg text-zinc-400 leading-relaxed max-w-lg">
              Connect with seniors, alumni, mentors, recruiters, and future co-founders. A professional hub engineered exclusively for the future generation of students.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md">
            <div className="flex items-start gap-3 p-3.5 rounded-xl border border-zinc-900 bg-zinc-900/30 backdrop-blur-sm">
              ...
              <div>
                <h3 className="text-sm font-semibold text-zinc-200">Alumni Referrals</h3>
                <p className="text-xs text-zinc-500 mt-0.5">Unlock internship routes directly.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl border border-zinc-900 bg-zinc-900/30 backdrop-blur-sm">
              ...
              <div>
                <h3 className="text-sm font-semibold text-zinc-200">Startup Teammates</h3>
                <p className="text-xs text-zinc-500 mt-0.5">Assemble hackers & builders.</p>
              </div>
            </div>
          </div>
